    ...
    <Section id="como-funciona" bg="secondary">
      ...
      >
        {comoFunciona.steps.map((step, i) => (
          <div
            key={step.n}
            className="relative w-[80vw] flex-none snap-center overflow-hidden rounded-2xl border border-line/60 bg-primary/60 p-6"
          >
            ...
            <span className="mt-4 block h-px w-8 bg-gold/40" />
          </div>
        ))}
      </div>
    </Section>
